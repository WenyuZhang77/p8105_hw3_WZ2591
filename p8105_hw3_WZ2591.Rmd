...
**1.**
The variable `reordered` means the product is been reordered or not. 
...
**2.** 
The variable `order_hour_of_day` records the time that the order was placed.
...
**3.** 
The variable `days_since_prior_order` represents the time since the last order.
...
**4.** 
The variable `product_name` reprensets the name of product.
